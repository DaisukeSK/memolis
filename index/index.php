...
<body>
    ...
    <!---------------- Form ---------------->
    <form action="data_delete.php" method="get"><!-- This form is for multiple data delete feature -->
        ...
        <ul class="dataList">
            ...
            <?php
                ...
                $sql='select * from words where userId="'.$_SESSION["userId"].'" order by second DESC';
            ...
            <li class="liCaption">
                ...
                <div class="divSubmit">
                    ...
                    <!-- <form action="data_delete.php" method="get"> -->
