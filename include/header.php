...
<div class="instruction">
    <div class="window"><div class="x"><img src="../assets/svg/x2.svg">
    </div>
    ...
    Click 
    <u><?php include "../assets/svgConversion/add2.html";?>Add data</u> 
...
anchors.forEach(val=>{
    if(val.href==location.href){
        // val.parentElement.style.background="linear-gradient(90deg, navy, transparent)"
        // val.parentElement.style.backgroundColor="navy"
    ...
    if(location.href.includes("practice.php")){
        // anchors[2].parentElement.style.background="linear-gradient(90deg, navy, transparent)"
